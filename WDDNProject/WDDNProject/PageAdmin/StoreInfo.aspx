<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" Inherits="PageAdmin_StoreInfo" Codebehind="StoreInfo.aspx.cs" %>
                ...
                <asp:Panel ID="formatTable" class="st" runat="server" Width="565px">
                    <table style="width: 573px; margin-right: 0px;" cellpadding="5" cellspacing="2" id="formtable">
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <asp:Label ID="txtLib" runat="server" Text="Lib"></asp:Label>
                            </td>
                        ...
                        <asp:DropDownList ID="ddlLib" runat="server" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="Lib_Id"></asp:DropDownList>        
