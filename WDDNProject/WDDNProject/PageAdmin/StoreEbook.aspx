                    ...
                    <table style="width: 573px; margin-right: 0px;" cellpadding="5" cellspacing="2" id="formtable">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtIsbn" Display="Dynamic" ErrorMessage="*" Font-Bold="True" ForeColor="Red" ValidationGroup="store">*</asp:RequiredFieldValidator>
                            </td>
